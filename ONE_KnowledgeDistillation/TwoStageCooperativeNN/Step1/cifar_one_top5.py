...
def main():
    ...
    if args.resume or args.evaluate:
        ...
        logger.set_names(['TAcc_1', 'VAcc_1','TAcc_2','VAcc_2','TAcc_3','VAcc_3','TAcc_4','VAcc_4','TAcc_5','VAcc_5','TAcc_e','VAcc_e'])
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        train_loss, train_acc_1,train_acc_2,train_acc_3,train_acc_4,train_acc_5,train_acc_en = train(trainloader, model, criterion, criterion_kl, optimizer, epoch,
                                      use_cuda)
        test_loss, test_acc_1,test_acc_2,test_acc_3,test_acc_4,test_acc_5,test_acc_en = test(testloader, model, use_cuda)

        # append logger file
        logger.append([train_acc_1, test_acc_1,train_acc_2,test_acc_2,train_acc_3,test_acc_3,train_acc_4,test_acc_4,train_acc_5,test_acc_5,train_acc_en,test_acc_en])
