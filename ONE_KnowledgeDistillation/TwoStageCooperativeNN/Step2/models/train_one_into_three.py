"""
cifar_one.py (refactored)

Generic training script for CIFAR-10/100 using ONE_ResNet variants.
Supports multi-branch cooperative models (1, 3, 5 branches).
"""
...
# Arguments
# ----------------------------
parser = argparse.ArgumentParser(description="PyTorch CIFAR Training (ONE-ResNet)")
...
def main():
    ...
    logger = Logger(os.path.join(args.checkpoint,"log.txt"), title="cifar_one")
